...
f_contrast_left = "trials.visualStim_contrastLeft.npy"
f_contrast_right = "trials.visualStim_contrastRight.npy"

# Location of the project
project_path = pathlib.Path().absolute()


filenames = [f_intervals, f_included, f_visStim_times, f_cue_times, f_choice,
             f_response_times, f_feedback_times, f_feedback_types, 
             f_contrast_left, f_contrast_right]


def load_trial_files (recording_name):
    data_path = os.path.join(project_path, 'data', recording_name)
    data_path = data_path.replace('Michalis/', '')
    alldata = []
    ...
    trials = {
        ...
        'left_contrast': alldata[8],
        'right_contrast': alldata[9]
    }
...
#          included_trials - boolean +1 included, 0 not included
  ...
  trials['left_contrast'] = trials['left_contrast'][idx,:]
  trials['right_contrast'] = trials['right_contrast'][idx,:]
